...
It's like a sourdough starter for websites. To use CakeWalk, make a copy of this project. Discard the git history. Develop your site according to the instructions below. Modify the included build system to suit your needs. Go wild, make a mess, this is your space to play. Replace all mentions of "CakeWalk" with the name of your site — including in this readme. In fact, delete this paragraph, and replace it with your own writing. But maybe keep the below, so people who want to help will know where to go.
...
One design detail that might be worth describing: there should *always* be a page in the content folder.
* We don't want the build system to auto-generate pages, because then you can't look at the URL of a page and just *know* where it comes from.
...
So, really, all you *need* to run the build system is a markdown renderer. The rest can be omitted, or implemented from scratch in an afternoon.
